...
export default class Footer extends React.Component {
    ...
    constructor(props) {
        ...
        this._email = "me@calumleask.co.uk";
        this._linkedin = "calumleask";
        this._copy = "\u00a9";
        this._year = "2020";
        this._name = "Calum Leask";
    }
        ...
        return (
            <StyledFooter>
                <Ul>
                    ...
                    <Li>
                        <a href="https://linkedin.com/in/calumleask">
                ...
                <p>Copyright {this._copy} {this._year} {this._name}</p>
            </StyledFooter>
        );
    }
}