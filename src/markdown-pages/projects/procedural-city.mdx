...
date: "2015-05"
tags: "Algorithms Procedural_Generation 3D_Graphics DirectX11 PC C++"
---
import Image from "src/components/Image.jsx"
import ResponsiveIFrame from "src/components/ResponsiveIFrame"

<ResponsiveIFrame aspect="4:3" src="https://www.youtube.com/embed/HQLa8YGWNwg"/>
...
<Image alt="Generated City" width="50%" maxWidth="400px" style={{margin:0}} src="/assets/projects/procedural-city/05.png"/>
<Image alt="Generated City" width="50%" maxWidth="400px" style={{margin:0}} src="/assets/projects/procedural-city/06.png"/>
...
<Image alt="Generating the Plots" maxWidth="800px" src="/assets/projects/procedural-city/plot_generation.gif"/>

The perimeter of the city is defined by a randomly sized quad. Voronoi points are placed inside the quad to create <a href="https://en.wikipedia.org/wiki/Voronoi_diagram" target="_blank">voronoi regions</a> which become the districts.
...
<Image alt="Generated Districts" maxWidth="800px" src="/assets/projects/procedural-city/00.png" caption="Figure 1. Districts (voronoi regions)"/>
...
<Image alt="Generated Blocks" maxWidth="800px" src="/assets/projects/procedural-city/01.png" caption="Figure 2. Districts divided into blocks"/>
...
<Image alt="Generated Plots" maxWidth="800px" src="/assets/projects/procedural-city/02.png" caption="Figure 3. Blocks divided into plots"/>
...
<Image alt="Generated Buildings" maxWidth="800px" src="/assets/projects/procedural-city/03.png" caption="Figure 4. Buildings on the plots"/>
...
<Image alt="Window Texture" width="25%" maxWidth="256px" src="/assets/projects/procedural-city/window_texture_0.png"/>
<Image alt="Window Texture" width="25%" maxWidth="256px" src="/assets/projects/procedural-city/window_texture_1.png"/>
<Image alt="Window Texture" width="25%" maxWidth="256px" src="/assets/projects/procedural-city/window_texture_2.png"/>
<Image alt="Window Texture" width="25%" maxWidth="256px" src="/assets/projects/procedural-city/window_texture_3.png" caption="Figure 5. Four different window texture types"/>
<br/>
<Image alt="Windows Lighting Up" maxWidth="800px" src="/assets/projects/procedural-city/04.png" caption="Figure 6. Windows lighting up at night"/>
