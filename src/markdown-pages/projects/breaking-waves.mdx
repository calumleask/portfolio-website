...
<Image alt="Shallow-Water Equations" width="60%" src="/assets/projects/breaking-waves/0.png"/>
...
<Image alt="generating Wave Meshes 1" width="60%" src="/assets/projects/breaking-waves/1.png"/>
...
<Image alt="Generating Wave Meshes 2" width="60%" src="/assets/projects/breaking-waves/2.png"/>
...
<Image alt="Particle Effects" width="60%" src="/assets/projects/breaking-waves/3.png"/>

Animated ripples combined with normal mapping distorts the surface of the water, creating very nice reflections
of the sky above.

<Image alt="Surface Detail and Reflections" width="60%" src="/assets/projects/breaking-waves/4.png"/>

A day-night cycle compliments the simulation, helping to show off the surface of the water and make it
visually exciting.

<Image alt="Day-Night Cycle" width="60%" src="/assets/projects/breaking-waves/5.png"/>