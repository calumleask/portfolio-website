...
<ImageGroup alt="Mandlebrot" width="30%" src={["/assets/projects/threading/mandlebrot_00.png",
...
<ImageGroup alt="Buddhabrot" width="30%" src={["/assets/projects/threading/buddhabrot0.gif",
